...
Param (
	...
	[string[]]
	$CommandPath = @("$global:testroot\..\ModuleExplorer\functions", "$global:testroot\..\ModuleExplorer\internal\functions"),
	
	[string]
	$ModuleName = "ModuleExplorer",
...
$CommandPath = @(
    "$global:testroot\..\ModuleExplorer\functions"
    "$global:testroot\..\ModuleExplorer\internal\functions"
)
