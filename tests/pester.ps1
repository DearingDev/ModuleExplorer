...
Remove-Module ModuleExplorer -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\ModuleExplorer\ModuleExplorer.psd1"
Import-Module "$PSScriptRoot\..\ModuleExplorer\ModuleExplorer.psm1" -Force
